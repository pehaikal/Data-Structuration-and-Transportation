insert into public.contacts (contact_email, contact_first_name, contact_last_name, contact_address, contact_city,
                             contact_country, contact_birthdate)
values ('jbutt@gmail.com', 'James', 'Butt', '6649 N Blue Gum St', 'New Orleans', 'USA', '1972-09-15'),
       ('josephine_darakjy@darakjy.org', 'Josephine', 'Darakjy', '4 B Blue Ridge Blvd', 'Brighton', 'USA',
        '1978-03-12'),
       ...
       ('amber_monarrez@monarrez.org', 'Amber', 'Monarrez', '14288 Foster Ave #4121', 'Jenkintown', 'USA',
        '1970-09-14'),
       ...
       ('deeanna_juhas@gmail.com', 'Deeanna', 'Juhas', '14302 Pennsylvania Ave', 'Huntingdon Valley', 'USA',
        '1973-08-07'),
       ...
       ('dominque.dickerson@dickerson.org', 'Dominque', 'Dickerson', '69 Marquette Ave', 'Hayward', 'USA',
        '1993-09-07'),
